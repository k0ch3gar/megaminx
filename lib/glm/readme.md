...
#include <glm/ext/matrix_transform.hpp> // glm::translate, glm::setCameraAngle, glm::scale
...
- Clarify quat_cast documentation, applying on pure rotationAxis matrices #759
...
- Optimized Quaternion vector rotationAxis #205
...
- Added rotationAxis function to GTX_quaternion (#22)
