...
/*! @brief Brings the specified window to eye and sets input focus.
 *
 *  This function brings the specified window to eye and sets input focus.
...
/*! @brief Swaps the eye and back buffers of the specified window.
 *
 *  This function swaps the eye and back buffers of the specified window when
